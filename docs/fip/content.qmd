...
![Figure 2](./_static/img/2.png){fig-align="default" width="100%"}
...
![Figure 3](./_static/img/3.png){fig-align="left" width=80%}
-->
...
- If the FIP has an orange annotation ‘update available’ click on the three dots on the right (3).

  ![Figure 3](./_static/img/3.png){fig-align="default" width="100%"}

  - Select Create Migration, click create and resolve all. This will update your project with the newest Knowledge Model.

- Then click again on the three dots and select Clone (4).

  ![Figure 4](./_static/img/4.png){fig-align="default" width="100%"}

- This will bring you to the FIP questionnaire. To change the name of the FIP you need to go to Settings (5). You can now start to work with the FIP Wizard questionnaire, and modify the previous FIP declarations (see below).

  ![Figure 5](./_static/img/5.png){fig-align="default" width="100%"}

### Make a new FIP

- Click **Create** (blue button on the top menu bar) (6).

  ![Figure 6](./_static/img/6.png){fig-align="default" width="100%"}

- You’ll see **Create Project** - this dialog box will launch your new FIP (7).

  ![Figure 7](./_static/img/7.png){fig-align="default" width="100%"}
...
On the left, the FIP Wizard displays a questionnaire navigation tool, indicating the chapters and the number of questions that still need to be answered for each chapter (9).

![Figure 9](./_static/img/9.png){fig-align="default" width="100%"}
...
**Chapter II. Metadata for your FAIR Implementation Profile** (10)
...
2.  Identify the person who will be responsible for completing the FIP questionnaire using ORCID.
...
![Figure 10](./_static/img/10.png){fig-align="default" width="100%"}
...
- In case your community is not in control of the resource, choose option **a. No Implementations choice** and add the resource as free text in the **Considerations** box (11).
...
![Figure 11](./_static/img/11.png){fig-align="default" width="100%"}

If your community uses a resource that has some level of FAIRness, then click option **b.** and add (declare) the FAIR Enabling Resource (or a list of resources by clicking the **+Add** button) (12).

![Figure 12](./_static/img/12.png){fig-align="default" width="100%"}

- The questionnaire asks you to select (from the drop-down list) a FER for that particular FAIR Principle (13).

![Figure 13](./_static/img/13.png){fig-align="default" width="100%"}
...
5.  After completing all required fields, go to **Documents** (14) and make a **new document**.

![Figure 14](./_static/img/14.png){fig-align="default" width="100%"}

6.  For Template choose **Nanopublication Template** and for Format choose **RDF Trig**.

7.  Push **Create**.

    If no error appears you can submit the nanopub clicking on the three dots (15):

    ![Figure 15](./_static/img/15.png){fig-align="default" width="100%"}
...
You will see the submission as a FER nanopub (16), the persistent identiﬁer (nanopub URI) is highlighted in orange.

![Figure 16](/docs/media/171.png){fig-align="default" width="100%"}
...
You will see the created FIP index nanopub (17)

![Figure 17](./_static/img/17.png){fig-align="default" width="100%"}

If you want to get a human-readable output (18) you could choose as document template:

     I. **Questionnaire Report** which gives you the options to create PDFs or Word documents

     II. **FIP Spreadsheet** to get CSV or Excel files (19)

![Figure 18](./_static/img/18.png){fig-align="default" width="100%"}

![Figure 19](./_static/img/19.png){fig-align="default" width="100%"}

If an error appears (20), you should be aware that all questions must have explicit answers: Some questions may have **null** answers, i.e., declarations that no choice was made.

![Figure 20](./_static/img/20.png){fig-align="default" width="100%"}

By choosing **HTML Preview** of the **Nanopublication Template** (in **Settings** - 21)

![Figure 21](./_static/img/21.png){fig-align="default" width="100%"}

you can see in **Preview mode** the question that needs revision (22).

![Figure 22](./_static/img/22.png){fig-align="default" width="100%"}
...
All the nanopublications representing your FIP - i.e., the FIC, the many FERs, and the index nanopub (indeed, all the semantic triples) - will be stored in a dedicated triple store and are available via a [SPARQL endpoint](https://virtuoso.nps.petapico.org/sparql). To get a matrix of all created FIPs, called FIP Matrix (23) use the [**FIP Matrix tool**](https://fipmatrix.knowledgepixels.com/), which automatically supports comparisons across communities and specific FAIR principles.

![Figure 23](./_static/img/FAIR%20Matrix.png){fig-align="default" width="55%"}

## Revising your FIP

Changes in the FIP are automatically saved.

There is no undo button for any action BUT you can use the version history button (24) which allows you to:
...
![Figure 24](./_static/img/24.png){fig-align="default" width="100%"}

If you want to answer a specific question later, click on the **plus button** to get a **TODO reminder** (25).

![Figure 25](./_static/img/25.png){fig-align="default" width="100%"}
