...
![Figure 1](./_static/img/1.png){fig-align="default" width="100%"}
...
![Typology](./_static/img/FSR%20Typology.png){fig-align="left" width=100%}
...
All the nanopublications representing your FIP - i.e., the FIC, the many FERs, and the index nanopub (indeed, all the semantic triples) - will be stored in a dedicated triple store and are available via a [SPARQL endpoint](https://virtuoso.nps.petapico.org/sparql). To get a matrix of all created FIPs, called FIP Matrix (23) download the [new_matrix.csv](https://github.com/peta-pico/dsw-nanopub-api/blob/main/tables/new_matrix.csv). The [**FIP Matrix tool**](https://fip-matrix.streamlit.app/) automatically supports such comparisons across communities and specific FAIR principles.
