...
- Resources supporting interoperability that were previously compiled in a Semantic Interoperability Profile (SIP) are incorporated into a standard FIP (version 5 and later) as supporting declarations, allowing streamlined and consistent management.
...
- To explore alignment and optimization opportunities, compare a FIP with FIPs from other communities. The [FIP Matrix tool](https://fip-matrix.streamlit.app/) supports such comparisons across communities and specific FAIR principles.  
...
## Getting started with the FIP 5.0
