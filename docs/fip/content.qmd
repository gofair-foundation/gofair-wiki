...
![FIP Wizard Dashboard](./_static/img/1.png){#fig-dashboard fig-align="default" width="100%"}
...
![Project List](./_static/img/2.png){#fig-projectList fig-align="default" width="100%"}
...
- If the FIP has an orange annotation ‘update available’ click on the three dots on the right (@fig-update).
  ...
  ![Migrate the project if necessary.](./_static/img/3.png){#fig-update fig-align="default" width="100%"}
...
- Then click again on the three dots and select Clone (@fig-clone).
  ...
  ![Clone the project.](./_static/img/4.png){#fig-clone fig-align="default" width="100%"}
...
- This will bring you to the FIP questionnaire. To change the name of the FIP you need to go to Settings (@fig-newName). You can now start to work with the FIP Wizard questionnaire, and modify the previous FIP declarations (see below).
  ...
  ![Change the name of the cloned project.](./_static/img/5.png){#fig-newName fig-align="default" width="100%"}

### Make a new FIP

- Click **Create** (blue button on the top menu bar) (@fig-create).

  ![Create a new project.](./_static/img/6.png){#fig-create fig-align="default" width="100%"}

- You’ll see **Create Project** - this dialog box will launch your new FIP (@fig-template).

  ![Select the project template.](./_static/img/7.png){#fig-template fig-align="default" width="100%"}
...
![Sharing](./_static/img/8.png){#fig-share fig-align="default" width="100%"}
...
![Navigation](./_static/img/9.png){#fig-navigation fig-align="default" width="100%"}
...
![Metadata for your FAIR Implementation Profile](./_static/img/10.png){#fig-chapterTwo fig-align="default" width="100%"}
...
![Option a. No implementation choice](./_static/img/11.png){#fig-optionA fig-align="default" width="100%"}
...
![Option b.](./_static/img/12.png){#fig-optionB fig-align="default" width="100%"}

- The questionnaire asks you to select (from the drop-down list) a FER for that particular FAIR Principle (@fig-selectFER).

![Select a FER](./_static/img/13.png){#fig-selectFER fig-align="default" width="100%"}
...
![Create a new document.](./_static/img/14.png){#fig-newDocument fig-align="default" width="100%"}
...
7.  Push **Create**.
    ...
    ![Submit](./_static/img/15.png){#fig-submit fig-align="default" width="100%"}
...
![](./_static/img/17.png){#fig-indexNano fig-align="default" width="100%"}
...
![Select the document template.](./_static/img/18.png){#fig-docTemplate fig-align="default" width="100%"}

![CSV file](./_static/img/19.png){#fig-csv fig-align="default" width="100%"}
...
![The latest submission has an error.](./_static/img/20.png){#fig-error fig-align="default" width="100%"}

By choosing **HTML Preview** of the **Nanopublication Template** (in **Settings** - @fig-html)

![HTML document format](./_static/img/21.png){#fig-html fig-align="default" width="100%"}

In **Preview mode** you can see the question that needs revision (@fig-preview).

![Preview shows an error](./_static/img/22.png){#fig-preview fig-align="default" width="100%"}
...
![Version History](./_static/img/24.png){#fig-versionHistory fig-align="default" width="100%"}

If you want to answer a specific question later, click on the **plus button** to get a **TODO reminder** (@fig-todo).

![Add a TODO](./_static/img/25.png){#fig-todo fig-align="default" width="100%"}
