...
**Overview on how to create a Semantic Interoperability Profile 2**

1.  **Getting started with the SIP Wizard 0.0.1 4**

2.  **Completing the SIP questionnaire 7**

3.  **Creating nanopublications 13**

4.  **Publishing your SIP 16**

5.  **Revising your SIP 21**
...
![](/docs/media/image_8.jpg){width="60%"}
...
![](/docs/media/9.png){width="60%"}

# 2. Completing the SIP questionnaire
...
![](/docs/media/image11.jpg){width="80%"}
...
![](/docs/media/figure12.jpg){width="80%"}
...
Note: those items in the list that are marked with the GFF ![](/docs/media/image14.png){width="10%"} qualification logo are quality-checked by the GO FAIR team. Others without badge have not yet been quality-checked.
...
# 3. Creating a nanopublication

**What is a nanopublication?**

![](/docs/media/icon%20(2).png){width="10%"} A nanopublication is a unitary assertion about the world with associated metadata, rendered in machine-readable form, and all of this having a globally unique, persistent and resolvable identifier (see [[here]{.underline}](https://nanopub.net) and [[here]{.underline})](https://peerj.com/articles/cs-387/).
...
![](/docs/media/image18.jpg){width="2.9791666666666665in" height="3.1979166666666665in"}

-   If no error appears you can submit the nanopub clicking on the three dots (**17**):

![](/docs/media/image19.jpg){width="1.5in" height="2.0729166666666665in"}
...
![](/docs/media/image_18.jpg)

# 4. Publishing your SIP
...
![](/docs/media/image23.jpg){width="90%"}
...
![](/docs/media/image24.jpg){width="100%"}
...
![](/docs/media/image25.jpg){width="50%"}

![](/docs/media/image26.jpg){width="60%"}
...
![](/docs/media/image27.jpg){width="60%"}
...
![](/docs/media/image28.jpg){width="3.3020833333333335in" height="4.770833333333333in"}
