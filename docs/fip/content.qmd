...
![Figure 1](./_static/img/1.png){fig-align="left" width=20%}
...
![Figure 2](./_static/img/2.png){fig-align="left" width=50%}
...
- If the FIP has an orange annotation ‘update available’ click on the three dots on the right (4).
  ...
  ![Figure 4](./_static/img/4.png){fig-align="left" width=80%}
...
- Then click again on the three dots and select Clone (5).
  ...
  ![Figure 5](./_static/img/5.png){fig-align="left" width=30%}
...
- This will bring you to the FIP questionnaire. To change the name of the FIP you need to go to Settings (6). You can now start to work with the FIP Wizard questionnaire, and modify the previous FIP declarations (see below).
  ...
  ![Figure 6](./_static/img/6.png){fig-align="left" width=40%}

### Make a new FIP

- Click **Create** (blue button on the top menu bar) (7).

  ![Figure 7](./_static/img/7.png){fig-align="left" width=100%}

- You’ll see **Create Project** - this dialog box will launch your new FIP (8).

  ![Figure 8](./_static/img/8.png){fig-align="left" width=40%}
...
![Figure 9](./_static/img/9.png){fig-align="left" width=60%}
...
![Figure 10](./_static/img/10.png){fig-align="left" width=100%}
...
![Figure 11](./_static/img/11.png){fig-align="left" width=100%}
...
![Figure 12](./_static/img/12.png){fig-align="left" width=100%}
...
![Figure 13](./_static/img/13.png){fig-align="left" width=100%}

- The questionnaire asks you to select (from the drop-down list) a FER for that particular FAIR Principle (14).

![Figure 14](./_static/img/14new.png){fig-align="left" width=100%}
...
![](/docs/img/nanopubstructure.jpg){fig-align="left" width="30%"}
...
![FER Definitions](./_static/img/FERdef.png){fig-align="left" width=100%}

In addition to FERs, there is the larger typology of FAIR Supporting Resources, that complement essential FERs.

![Typology](/docs/img/FSR typology.svg){fig-align="left" width=100%}
...
![Figure 15](./_static/img/15.png){fig-align="left" width=50%}
...
![Actions](/docs/img/actions.jpg){fig-align="default" width="100%"}
...
![Figure 18](/docs/img/img18.jpg){fig-align="left" width="100%"}
...
![Figure 19](./_static/img/19.png){fig-align="left" width="40%"}

![Figure 20](./_static/img/20.png){fig-align="default" width="70%"}
...
![Figure 22](./_static/img/22.png){fig-align="left" width="45%"}

you can see in **Preview mode** the question that needs revision (23).

![Figure 23](./_static/img/23.png){fig-align="left" width="50%"}
...
All the nanopublications representing your FIP - i.e., the FIC, the many FERs, and the index nanopub (indeed, all the semantic triples) - will be stored in a dedicated triple store and are available via a [SPARQL endpoint](https://virtuoso.nps.petapico.org/sparql). To get a matrix of all created FIPs, called FIP Matrix (24) download the [new_matrix.csv](https://github.com/peta-pico/dsw-nanopub-api/blob/main/tables/new_matrix.csv). The [**FIP Matrix tool**](https://fip-matrix.streamlit.app/) automatically supports such comparisons across communities and specific FAIR principles.

![Figure 24](./_static/img/24.png){fig-align="default" width="55%"}
...
![Figure 25](./_static/img/25.png){fig-align="left" width="40%"}

If you want to answer a specific question later, click on the **plus button** to get a **TODO reminder** (26).

![Figure 26](./_static/img/26.png){fig-align="default" width="100%"}
