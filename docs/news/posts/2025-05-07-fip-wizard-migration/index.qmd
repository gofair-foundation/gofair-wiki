...
We are migrating the production environment of the **FIP Wizard** to a new URL. Starting **May 14**, the service will be available at: https://fip.fair-wizard.com
Key Dates:

**May 13**: The current FIP/FSR submission service will be temporarily unavailable during the transition.

**May 14**: The new FIP Wizard instance goes live.

**June 4**: The current (old) instance will be fully decommissioned.
...
If you have a **project without a published document** that you want to ensure gets transferred automatically to the new instance, please add its URL to this [sheet] at latest by **Monday, May 12**.
